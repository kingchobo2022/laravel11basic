<x-layout>
    ...
    <div class="max-w-2xl mx-auto p-3">
        <form method="POST" action="{{ route('login.store') }}">
            ...
            <div class="mb-6">
                <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">로그인</button>
            </div>
        </form>
    </div>
</x-layout>